    ...
    <div class="d-flex justify-content-center">
        <form class="form" action="{{ route('donaturs.store') }}" method="POST">
            ...
            <div class="card" id="card1">
                ...
                <div class="group">
                    <textarea placeholder="" id="comment" name="pesan" rows="5" required
                        spellcheck="false">{{ old('pesan') }}</textarea>
            ...
            <div class="card" id="card2">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        <label>
                            <input class="radio-input" type="radio" name="tipe_bayar" value="bni" required />
                            <span class="radio-tile">
                                <span class="radio-icon">
                    ...
                    <div class="col-sm">
                        <label>
                            <input class="radio-input" type="radio" name="tipe_bayar" value="bri" required />
                            <span class="radio-tile">
                                <span class="radio-icon">
                    ...
                    <div class="col-sm">
                        <label>
                            <input class="radio-input" type="radio" name="tipe_bayar" value="ovo" required />
                            <span class="radio-tile">
                                <span class="radio-icon">
